...
struct EShape {
	...
	static EShapeData EShape::createEClosedCylinderY(const Material &mat, float R, float height, int slices);
	static EShapeData EShape::createEMyPlane(const Material &mat, float halfOfWidth, float halfOfLength);
